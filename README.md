...
**NovaVerge** is a **demo website** created as a professional front-end development project built using **Bootstrap 5** and custom **CSS**. It represents a clean, modern consulting firm focused on eco-friendly operations and smart technologies.
